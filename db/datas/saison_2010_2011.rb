...
gel = Typeculture.find_by_name("Gel")
...
#Saison
saison_2010_2011 = Saison.create!(:name => "2010/2011", :year => "2011")
Setting.find(:first).update_attribute(:saison_id,	saison_2010_2011.id )

zone = Zone.find_by_code('bons_pains')
parcelle = Parcelle.create!(:name => 'Bons Pains', :code => 'bons_pains', :saison =>  saison_2010_2011, :typeculture => ble, :surface => 14.03, :surface_pac => 14.03)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('mitant')
parcelle = Parcelle.create!(:name => 'Mitant', :code => 'mitant', :saison =>  saison_2010_2011, :typeculture => ble, :surface => 5.1, :surface_pac => 5.1)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('la_rue')
parcelle = Parcelle.create!(:name => 'etandage', :code => 'etandage', :saison =>  saison_2010_2011, :typeculture => gel, :surface => 0.2, :surface_pac => 0.2)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)
...
zone = Zone.find_by_code('la_rue')
parcelle = Parcelle.create!(:name => 'Derriere', :code => 'derriere', :saison =>  saison_2010_2011, :typeculture => colza, :surface => 12.2, :surface_pac => 12.2)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('la_rue')
parcelle = Parcelle.create!(:name => 'Champ du Milieu', :code => 'champ_du_milieu', :saison =>  saison_2010_2011, :typeculture => tournesol, :surface => 10, :surface_pac => 10)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('vallees')
parcelle = Parcelle.create!(:name => 'Les Vallees', :code => 'vallees', :saison =>  saison_2010_2011, :typeculture => tournesol, :surface => 11, :surface_pac => 11)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('vallees')
parcelle = Parcelle.create!(:name => 'Lapins', :code => 'lapins', :saison =>  saison_2010_2011, :typeculture => gel, :surface => 0.4, :surface_pac => 0.4)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('vallees')
parcelle = Parcelle.create!(:name => 'La Cote', :code => 'cote', :saison =>  saison_2010_2011, :typeculture => foin, :surface => 2.3, :surface_pac => 2.3)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('guiberons')
parcelle = Parcelle.create!(:name => 'Guiberons', :code => 'guiberons', :saison =>  saison_2010_2011, :typeculture => foin, :surface => 3, :surface_pac => 3)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)
...
zone = Zone.find_by_code('feuillets')
parcelle = Parcelle.create!(:name => 'Feuillet-2', :code => 'feuillets_2', :saison =>  saison_2010_2011, :typeculture => foin, :surface => 4.08, :surface_pac => 4.08)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)
...
parcelle = Parcelle.create!(:name => 'Brandes-1', :code => 'brandes_1', :saison =>  saison_2010_2011, :typeculture => foin, :surface => 2.47, :surface_pac => 2.47)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('brandes')
parcelle = Parcelle.create!(:name => 'Brandes-2', :code => 'brandes_2', :saison =>  saison_2010_2011, :typeculture => miscanthus, :surface => 0.5, :surface_pac => 0.5)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('taillis')
parcelle = Parcelle.create!(:name => 'Taillis-1', :code => 'taillis_1', :saison =>  saison_2010_2011, :typeculture => foin, :surface => 19.05, :surface_pac => 19.05)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('taillis')
parcelle = Parcelle.create!(:name => 'Taillis-2', :code => 'taillis_2', :saison =>  saison_2010_2011, :typeculture => miscanthus, :surface => 0.3, :surface_pac => 0.3)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('varennes')
parcelle = Parcelle.create!(:name => 'Varennes-1', :code => 'varennes_1', :saison =>  saison_2010_2011, :typeculture => foin, :surface => 14.7, :surface_pac => 14.7)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('varennes')
parcelle = Parcelle.create!(:name => 'Varennes-2', :code => 'varennes_2', :saison =>  saison_2010_2011, :typeculture => miscanthus, :surface => 0.8, :surface_pac => 0.8)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('varennes')
parcelle = Parcelle.create!(:name => 'Varennes-3', :code => 'varennes_3', :saison =>  saison_2010_2011, :typeculture => gel, :surface => 0.39, :surface_pac => 0.39)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('patureaux')
parcelle = Parcelle.create!(:name => 'Patureaux', :code => 'patureaux', :saison =>  saison_2010_2011, :typeculture => foin, :surface => 8.88, :surface_pac => 8.88)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('chevaux')
parcelle = Parcelle.create!(:name => 'Chevaux-1', :code => 'chevaux_1', :saison =>  saison_2010_2011, :typeculture => foin, :surface => 12.26, :surface_pac => 12.26)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('chevaux')
parcelle = Parcelle.create!(:name => 'Chevaux-2', :code => 'chevaux_2', :saison =>  saison_2010_2011, :typeculture => autre, :surface => 1, :surface_pac => 1)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)
...
parcelle = Parcelle.create!(:name => 'Basse-cour', :code => 'basse_cour', :saison =>  saison_2010_2011, :typeculture => colza, :surface => 2.35, :surface_pac => 2.55)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)

zone = Zone.find_by_code('reserve')
parcelle = Parcelle.create!(:name => 'Reserve', :code => 'reserve', :saison =>  saison_2010_2011, :typeculture => autre, :surface => 0.2, :surface_pac => 0.2)
zonetopa = Zonetopa.create!(:parcelle => parcelle, :zone => zone, :value => parcelle.surface)
...
parcelles_cultures = []
ble.parcelles.find_by_saison(:all, saison_2010_2011).each {|parcelle| parcelles_cultures << parcelle}
colza.parcelles.find_by_saison(:all, saison_2010_2011).each {|parcelle| parcelles_cultures << parcelle}
tournesol.parcelles.find_by_saison(:all, saison_2010_2011).each {|parcelle| parcelles_cultures << parcelle}


# PRODUITS - (Generation automatique xls)
altigo = Produit.create!(:name => 'Altigo', :unit =>'kg', :category => cat_agri_semis, :saison => saison_2010_2011, :desc => 'semence ble')
...
aubisque = Produit.create!(:name => 'aubisque', :unit =>'L', :category => cat_agri_semis, :saison => saison_2010_2011, :desc => 'semence ray grass')
autan = Produit.create!(:name => 'Autan', :unit =>'kg', :category => cat_agri_semis, :saison => saison_2010_2011, :desc => 'semence ble')
...
cline = Produit.create!(:name => 'Cline', :unit =>'L', :category => cat_agri_herbicide, :saison => saison_2010_2011, :desc => 'pour tournesol')
...
cp151515 = Produit.create!(:name => '15-15-15', :unit =>'kg', :category => cat_agri_engrais, :saison => saison_2010_2011, :desc => 'pour le jardin')
...
mas91 = Produit.create!(:name => 'MAS 91', :unit =>'L', :category => cat_agri_semis, :saison => saison_2010_2011, :desc => 'semence tournesol')
...
paledor = Produit.create!(:name => 'Paledor', :unit =>'kg', :category => cat_agri_semis, :saison => saison_2010_2011, :desc => 'pour ble')
picabore = Produit.create!(:name => 'Picabore', :unit =>'L', :category => cat_agri_oligo, :saison => saison_2010_2011, :desc => '')
picosolo = Produit.create!(:name => 'Picosolo', :unit =>'L', :category => cat_agri_herbicide, :saison => saison_2010_2011, :desc => '')
pr = Produit.create!(:name => 'Pr', :unit =>'kg', :category => cat_agri_semis, :saison => saison_2010_2011, :desc => 'ble')
...
facture = Debit.create!(:name => 'Sacs B.B Adivalor', :date => '2010-11-30', :cout => 2.5, :ref_client => '01-2010-1187', :ref => '001', :user => User.find_by_code('dauger'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_divers, :desc => '1 sac big bag',:saison => saison_2010_2011, :star => 0, :adu => 0)
...
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
...
facture = Debit.create!(:name => 'Sacs B.B Adivalor', :date => '2011-04-30', :cout => 5, :ref_client => '01-2010-2593', :ref => '004', :user => User.find_by_code('dauger'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_divers, :desc => '2 sac big bag',:saison => saison_2010_2011, :star => 0, :adu => 0)
...
facture = Debit.create!(:name => 'Tournesol Campus', :date => '2011-03-11', :cout => 994, :ref_client => '01-2010-1767', :ref => '006', :user => User.find_by_code('dauger'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_semence, :desc => 'avoir 2x142=284euros. Avoir du 30/04/2011. ref 2627.',:saison => saison_2010_2011, :star => 0, :adu => 0)
...
facture = Debit.create!(:name => 'produits phyto 2', :date => '2011-04-30', :cout => 1629, :ref_client => '01-2010-2594', :ref => '009', :user => User.find_by_code('dauger'), :factype => factype_diff,:factcat => factcat_agri,:category => cat_agri_produits_phyto, :desc => 'La valeur du cp151515 (0.25euros pour jardin) est deduit du prix de cette facture (1654-25=1619). avoir de 2% sous condition. Le karate a-t-il ete rendu a dauger?',:saison => saison_2010_2011, :star => 1, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
...
reportable = Reportable.create!(:name => 'produits phyto 4', :date => '2010-10-31', :cout => 998.99, :ref_client => '01-2010-975', :ref => '012', :user => User.find_by_code('dauger'), :factype => factype_null,:factcat => factcat_agri,:category => cat_agri_produits_phyto, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
facture = Report.create!(:reportable => reportable, :name => 'semences ble', :date => '2010-10-31', :cout => 415.5, :ref_client => '01-2010-975', :ref => '012', :user => User.find_by_code('dauger'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_semence, :desc => 'paledor:123,6=2x61,8. altigo:127,6=2x63,8. Pr:164,29=7x23,47',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_ble.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
facture = Report.create!(:reportable => reportable, :name => 'produits cultures 4', :date => '2010-10-31', :cout => 583.49, :ref_client => '01-2010-975', :ref => '012', :user => User.find_by_code('dauger'), :factype => factype_diff,:factcat => factcat_agri,:category => cat_agri_produits_phyto, :desc => 'produits non associes = jachere? A DETERMINER',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
...
reportable = Reportable.create!(:name => 'produits phyto 5', :date => '2010-09-27', :cout => 4907.4, :ref_client => '01-2010-471', :ref => '013', :user => User.find_by_code('dauger'), :factype => factype_null,:factcat => factcat_agri,:category => cat_agri_produits_phyto, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
facture = Report.create!(:reportable => reportable, :name => 'produits prairies', :date => '2010-09-27', :cout => 3152.9, :ref_client => '01-2010-471', :ref => '013', :user => User.find_by_code('dauger'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_produits_phyto, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_foin.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
facture = Report.create!(:reportable => reportable, :name => 'produits cultures', :date => '2010-09-27', :cout => 1754.5, :ref_client => '01-2010-471', :ref => '013', :user => User.find_by_code('dauger'), :factype => factype_diff,:factcat => factcat_agri,:category => cat_agri_produits_phyto, :desc => 'produits non associes = jachere? A DETERMINER',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
...
fac_pulve = Report.create!(:reportable => reportable, :name => 'Pulvérisation', :date => '2011-01-30', :cout => 955, :ref_client => '19', :ref => '021', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '95,5Ha x 10€ = 955€',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => fac_pulve)}
facture = Report.create!(:reportable => reportable, :name => 'Broyage haies', :date => '2011-01-30', :cout => 456, :ref_client => '19', :ref => '021', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '12h x 38€ = 456€',:saison => saison_2010_2011, :star => 0, :adu => 0)
facture = Report.create!(:reportable => reportable, :name => 'Broyage horizontal', :date => '2011-01-30', :cout => 297.5, :ref_client => '19', :ref => '021', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '8h50 x 35€/h = 297,5. Imputer sur le Tournesol',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_tournesol.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
fac_semis = Report.create!(:reportable => reportable, :name => 'Semis Colza et Blé', :date => '2011-01-30', :cout => 1829, :ref_client => '19', :ref => '021', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '59ha x 31€/ha = 1829€',:saison => saison_2010_2011, :star => 0, :adu => 0)
...
facture = Report.create!(:reportable => reportable, :name => 'Roulage', :date => '2011-01-30', :cout => 465, :ref_client => '18', :ref => '022', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '15h30 x 30€/h = 465€. Imputer sur Ble et Colza',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
parcelles_colza.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
parcelles_ble.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
fac_covercrop = Report.create!(:reportable => reportable, :name => 'Cover-crop', :date => '2011-01-30', :cout => 2240, :ref_client => '18', :ref => '022', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '64h x 35€/h = 2240€. Imputer sur Ble, Colza, Tournesol',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => fac_covercrop)}
facture = Report.create!(:reportable => reportable, :name => 'Vibro', :date => '2011-01-30', :cout => 810, :ref_client => '18', :ref => '022', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '81ha au lieu de 79 x 10€ = 810€',:saison => saison_2010_2011, :star => 1, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
...
facture = Report.create!(:reportable => reportable, :name => 'Labour + Herse', :date => '2011-01-30', :cout => 2830, :ref_client => '20', :ref => '023', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => 'Mise en prairie (semis prairies ~19ha) Imputer sur parcelles_foin',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_foin.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
facture = Report.create!(:reportable => reportable, :name => 'Epandage chaux', :date => '2011-01-30', :cout => 120, :ref_client => '20', :ref => '023', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => 'Imputer sur parcelles_foin',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_foin.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
...
fac_engrais = Report.create!(:reportable => reportable, :name => 'Epandage engrais', :date => '2011-07-19', :cout => 2520, :ref_client => '24', :ref => '024', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '252 ha x 10€ = 2520€',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => fac_engrais)}
fac_pulve_2 = Report.create!(:reportable => reportable, :name => 'Pulvérisation cultures', :date => '2011-07-19', :cout => 2850, :ref_client => '24', :ref => '024', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '285 ha x 10€ = 2850€',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => fac_pulve_2)}
facture = Report.create!(:reportable => reportable, :name => 'tours de champs', :date => '2011-07-19', :cout => 120, :ref_client => '24', :ref => '024', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '4h x 30€/h = 120€ (desherbage)',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
...
fac_vibro = Report.create!(:reportable => reportable, :name => 'Vibro', :date => '2011-07-19', :cout => 200, :ref_client => '25', :ref => '025', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '20ha x 10€ = 200€',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_tournesol.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => fac_vibro)}
facture = Report.create!(:reportable => reportable, :name => 'Orge', :date => '2011-07-19', :cout => 26.4, :ref_client => '25', :ref => '025', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '150kg x 176€/t = 26,40€ transport orge',:saison => saison_2010_2011, :star => 0, :adu => 0)

fac_moisson = Debit.create!(:name => 'moisson cultures', :date => '2011-10-26', :cout => 5475, :ref_client => '31', :ref => '026', :user => User.find_by_code('trochet'), :factype => factype_total,:factcat => factcat_agri,:category => cat_agri_service_agricole, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => fac_moisson)}

facture = Debit.create!(:name => 'PRODUITS MANQUANTS', :date => '2011-02-28', :cout => 168, :ref_client => '0000', :ref => '028', :user => User.find_by_code('dauger'), :factype => factype_diff,:factcat => factcat_agri,:category => cat_agri_produits_phyto, :desc => '',:saison => saison_2010_2011, :star => 1, :adu => 0)
parcelles_cultures.each {|p| factoparcelle = Factoparcelle.create!(:parcelle => p, :facture => facture)}
protofacture = Protofacture.create!(:facture => facture, :produit => azomag, :prix_unit => 0.28, :quantite => 600, :saison => saison_2010_2011)
...
vente = Vente.create!(:name => 'Demanus - paille colza', :date => '2011-08-01', :prix => 1921.92, :ref_client => '', :ref => '002', :user => User.find_by_name('Demanus'),:category => cat_vente_paille_colza, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_colza.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}
vente = Vente.create!(:name => 'Demanus - paille colza', :date => '2011-08-01', :prix => 640, :ref_client => '', :ref => '002', :user => User.find_by_name('Demanus'),:category => cat_vente_paille_colza, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_colza.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}
...
vente = Vente.create!(:name => 'PAC - Pac', :date => '2011-01-20', :prix => 37418.60, :ref_client => '', :ref => '', :user => User.find_by_name('PAC'),:category => cat_vente_pac, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)

vente = Vente.create!(:name => 'Dauger - Ble 1', :date => '2011-08-08', :prix => 1860.47, :ref_client => 'VPV-01-2011-78', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_ble, :desc => '10.95 t',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_ble.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

vente = Vente.create!(:name => 'Dauger - Ble 2', :date => '2011-09-07', :prix => 1791.75, :ref_client => 'VPV-01-2011-150', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_ble, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_ble.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

vente = Vente.create!(:name => 'Dauger - Ble 3', :date => '2011-10-21', :prix => 1256.68, :ref_client => 'VPV-01-2011-303', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_ble, :desc => '7.68 t',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_ble.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

vente = Vente.create!(:name => 'Dauger - Ble 4', :date => '2011-11-23', :prix => 3586.89, :ref_client => 'VPV-01-2011-396', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_ble, :desc => '20.08 t',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_ble.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

vente = Vente.create!(:name => 'Dauger - A VENDRE', :date => '2012-02-15', :prix => 16000, :ref_client => '', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_ble, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_ble.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

vente = Vente.create!(:name => 'Dauger - Tournesol 1', :date => '2011-11-30', :prix => 1876.49, :ref_client => 'VPV-01-2011-553', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_tournesol, :desc => '5.27 t',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_tournesol.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

vente = Vente.create!(:name => 'Dauger - Tournesol 2', :date => '2011-11-30', :prix => 3649.71, :ref_client => 'VPV-01-2011-554', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_tournesol, :desc => '10.25 t',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_tournesol.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

vente = Vente.create!(:name => 'Dauger - Tournesol 3', :date => '2012-02-02', :prix => 3936.00, :ref_client => '', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_tournesol, :desc => '9.84 t',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_tournesol.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

vente = Vente.create!(:name => 'Dauger - Colza', :date => '2011-11-07', :prix => 14308.10, :ref_client => 'VPV-01-2011-360', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_colza, :desc => '35.61 t',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_colza.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

vente = Vente.create!(:name => 'Groupama - Assurance', :date => '2011-11-30', :prix => 3332, :ref_client => '', :ref => '', :user => User.find_by_name('Groupama'),:category => cat_vente_tournesol, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
parcelles_tournesol.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}

#vente = Vente.create!(:name => 'Dauger - Assurance', :date => '2011-11-07', :prix => 3332, :ref_client => '', :ref => '', :user => User.find_by_name('Dauger'),:category => cat_vente_tournesol, :desc => '',:saison => saison_2010_2011, :star => 0, :adu => 0)
#parcelles_tournesol.each {|p| ventoparcelle = Ventoparcelle.create!(:parcelle => p, :vente => vente)}
