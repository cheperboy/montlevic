...
challenge = Produit.create!(:name => 'Challenge', :unit =>'L', :category => cat_desherbant, :saison => saison_2010_2011, :desc => 'pour ble')
...
cline = Produit.create!(:name => 'Cline', :unit =>'L', :category => cat_desherbant, :saison => saison_2010_2011, :desc => 'ammonitrate')
...
glifonet = Produit.create!(:name => 'Glifonet', :unit =>'L', :category => cat_desherbant, :saison => saison_2010_2011, :desc => 'GLYPHOSATE')
...
stratos = Produit.create!(:name => 'Stratos', :unit =>'L', :category => cat_desherbant, :saison => saison_2010_2011, :desc => 'MAISON - pour arbres fruitiers')
vip = Produit.create!(:name => 'Vip', :unit =>'L', :category => cat_desherbant, :saison => saison_2010_2011, :desc => 'pour ble')
huile = Produit.create!(:name => 'Huile', :unit =>'L', :category => cat_divers, :saison => saison_2010_2011, :desc => 'STOCKAGE SILO')
...
amistar_xtra = Produit.create!(:name => 'Amistar Xtra', :unit =>'L', :category => cat_fongicide, :saison => saison_2010_2011, :desc => 'MAISON - pour le jardin')
...
nuvagrain = Produit.create!(:name => 'Nuvagrain', :unit =>'L', :category => cat_insecticide, :saison => saison_2010_2011, :desc => '')
...
harmony = Produit.create!(:name => 'Harmony', :unit =>'L', :category => cat_desherbant, :saison => saison_2010_2011, :desc => '')
...
fac_semis_tournesol = Report.create!(:reportable => reportable, :name => 'semis tournesol', :date => '2011-07-19', :cout => 300, :ref_client => '24', :ref => '024', :user => trochet, :factype => factype_diff,:factcat => factcat_agri,:category => cat_service_agri, :desc => '20ha x 15€/ha = 300€ (Semis tournesol Tracteur)',:saison => saison_2010_2011, :star => 0)
...
fac_moisson_ble = Report.create!(:reportable => reportable, :name => 'Moissonnage Blé colza, Tournesol', :date => '2010-11-07', :cout => 6375, :ref_client => '50', :ref => '026', :user => trochet, :factype => factype_diff,:factcat => factcat_agri,:category => cat_service_agri, :desc => '85ha x 75€/ha = 6375€',:saison => saison_2010_2011, :star => 0)
