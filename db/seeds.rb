...
cat_maison_frais_generaux = Category.create!({:factcat => factcat_maison, :upcategory => upcategory_facture, :name => 'frais generaux', :code => 'maison_frais_generaux'})
cat_maison_batiment = Category.create!({:factcat => factcat_maison, :upcategory => upcategory_facture, :name => 'batiment', :code => 'maison_batiment'})
cat_maison_telephone = Category.create!({:factcat => factcat_maison, :upcategory => upcategory_facture, :name => 'telephone', :code => 'maison_telephone'})
cat_maison_edf = Category.create!({:factcat => factcat_maison, :upcategory => upcategory_facture, :name => 'edf', :code => 'maison_edf'})
cat_invest_materiel = Category.create!({:factcat => factcat_invest, :upcategory => upcategory_facture, :name => 'materiel', :code => 'invest_materiel'})
cat_invest_batiment = Category.create!({:factcat => factcat_invest, :upcategory => upcategory_facture, :name => 'batiment', :code => 'invest_batiment'})

#Categories Vente
cat_vente_paille_foin = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'paille foin', :code => 'vente_paille_foin'})
cat_vente_paille_ble = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'paille ble', :code => 'vente_paille_ble'})
cat_vente_paille_colza = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'paille colza', :code => 'vente_paille_colza'})
cat_vente_foin = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'foin', :code => 'vente_foin'})
cat_vente_ble = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'ble', :code => 'vente_ble'})
cat_vente_colza = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'colza', :code => 'vente_colza'})
cat_vente_assurance = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'Assurance', :code => 'vente_assurance'})
cat_vente_pac = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'PAC', :code => 'vente_pac'})
cat_vente_avoir = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'avoir', :code => 'vente_avoir'})
cat_vente_tournesol = Category.create!({:factcat => factcat_agri, :upcategory => upcategory_vente, :name => 'tournesol', :code => 'vente_tournesol'})
