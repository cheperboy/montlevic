...
SAISON_2010_2011 = true
SAISON_2009_2010 = true

#===== SEEDS_BASIC ========
if SEEDS_BASIC
  setting = Setting.create!(:saison_id => 1, :float_precision => 1, :value_parcelle => false, :detail_desc => false, :detail_ref => false)
